...
import type { OctopusPluginApi } from "octopus/plugin-sdk/feishu";
...
function readConfiguredDefaultAccountId(config: OctopusPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<OctopusPluginApi, "config">;
