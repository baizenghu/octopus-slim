/**
 * 个人 MCP Server 管理组件（共享）
 *
 * 被 McpSettingsPage 和 PersonalSettingsPage 复用，
 * 提供完整的个人 MCP CRUD（列表、新建/编辑、删除、测试连接、上传部署）。
 */
import { useState, useEffect, useCallback, useRef } from 'react';
import { toast } from 'sonner';
import { Plus, Trash2, Pencil, Zap, Loader2, Upload, X } from 'lucide-react';
...
interface PersonalMcpManagerProps {
  /** 操作完成（增删改）后的回调 */
  onUpdate?: () => void;
}

export default function PersonalMcpManager({ onUpdate }: PersonalMcpManagerProps) {
