const KEY = "octopus.control.settings.v1";
const LEGACY_TOKEN_SESSION_KEY = "octopus.control.token.v1";
const TOKEN_SESSION_KEY_PREFIX = "octopus.control.token.v1:";
...
export function loadSettings(): UiSettings {
  const defaultUrl = (() => {
    ...
    const configured =
      ...
      typeof window.__OCTOPUS_CONTROL_UI_BASE_PATH__ === "string" &&
      window.__OCTOPUS_CONTROL_UI_BASE_PATH__.trim();
