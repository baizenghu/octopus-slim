import type {
  ...
  DmPolicy,
  WizardPrompter,
} from "octopus/plugin-sdk/bluebubbles";
import {
  DEFAULT_ACCOUNT_ID,
  formatDocsLink,
...
function setBlueBubblesDmPolicy(cfg: OctopusConfig, dmPolicy: DmPolicy): OctopusConfig {
  ...
  configure: async ({ cfg, prompter, accountOverrides, shouldPromptAccountIds }) => {
    ...
    await prompter.note(
      [
        ...
        "2. Add your Octopus gateway URL + webhook path",
