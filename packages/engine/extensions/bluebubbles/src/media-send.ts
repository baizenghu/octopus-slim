...
import { resolveChannelMediaMaxBytes, type OctopusConfig } from "octopus/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: OctopusConfig; accountId?: string }): string[] {
