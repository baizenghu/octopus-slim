import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "octopus/plugin-sdk/account-id";
import { createAccountListHelpers, type OctopusConfig } from "octopus/plugin-sdk/bluebubbles";
...
export function listEnabledBlueBubblesAccounts(cfg: OctopusConfig): ResolvedBlueBubblesAccount[] {
