...
import { createAccountListHelpers, type OctopusConfig } from "octopus/plugin-sdk/mattermost";
...
export function listEnabledMattermostAccounts(cfg: OctopusConfig): ResolvedMattermostAccount[] {
