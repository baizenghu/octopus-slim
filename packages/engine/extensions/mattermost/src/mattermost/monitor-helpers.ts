...
export { createDedupeCache, rawDataToString } from "octopus/plugin-sdk/mattermost";
...
function listAgents(cfg: OctopusConfig): AgentEntry[] {
...
export function resolveIdentityName(cfg: OctopusConfig, agentId: string): string | undefined {
