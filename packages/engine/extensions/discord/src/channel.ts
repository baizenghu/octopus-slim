import { createScopedChannelConfigBase } from "octopus/plugin-sdk/compat";
import {
...
} from "octopus/plugin-sdk/compat";
import {
...
} from "octopus/plugin-sdk/discord";
...
export const discordPlugin: ChannelPlugin<ResolvedDiscordAccount> = {
  ...
  agentPrompt: {
    messageToolHints: () => [
      ...
      "- Forms: add `components.modal` (title, fields). Octopus adds a trigger button and routes submissions as new messages.",
    ],
  },
  messaging: {
