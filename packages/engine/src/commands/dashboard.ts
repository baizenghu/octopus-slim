...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set OCTOPUS_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `octopus dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control Octopus.");
  } else if (hint) {
    runtime.log(hint);
  }
}
