...
function resolveDefaultAccountId(cfg: OctopusConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OctopusConfig): boolean {
...
export function summarizeBindings(cfg: OctopusConfig, bindings: AgentBinding[]): string[] {
