...
describe("modelsAuthLoginCommand", () => {
  ...
  let currentConfig: OctopusConfig;
  let lastUpdatedConfig: OctopusConfig | null;
  ...
  beforeEach(() => {
    ...
    mocks.resolveAgentDir.mockReturnValue("/tmp/octopus/agents/main");
    mocks.resolveAgentWorkspaceDir.mockReturnValue("/tmp/octopus/workspace");
    mocks.resolveDefaultAgentWorkspaceDir.mockReturnValue("/tmp/octopus/workspace");
    mocks.loadValidConfigOrThrow.mockImplementation(async () => currentConfig);
    mocks.updateConfig.mockImplementation(
      async (mutator: (cfg: OctopusConfig) => OctopusConfig) => {
