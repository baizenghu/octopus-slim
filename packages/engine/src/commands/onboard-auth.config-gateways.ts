...
export function applyVercelAiGatewayProviderConfig(cfg: OctopusConfig): OctopusConfig {
...
export function applyVercelAiGatewayConfig(cfg: OctopusConfig): OctopusConfig {
