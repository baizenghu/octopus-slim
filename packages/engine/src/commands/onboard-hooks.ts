...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.octopus.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("octopus hooks list")}`,
      `  ${formatCliCommand("octopus hooks enable <name>")}`,
      `  ${formatCliCommand("octopus hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
