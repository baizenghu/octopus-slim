...
function resolveResolutionLimits(config: OctopusConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: OctopusConfig): SecretProviderConfig {
