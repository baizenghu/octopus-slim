...
export function listAuthProfileStorePaths(config: OctopusConfig, stateDir: string): string[] {
...
export function listAgentModelsJsonPaths(config: OctopusConfig, stateDir: string): string[] {
