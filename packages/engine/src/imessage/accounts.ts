...
function mergeIMessageAccountConfig(cfg: OctopusConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: OctopusConfig): ResolvedIMessageAccount[] {
