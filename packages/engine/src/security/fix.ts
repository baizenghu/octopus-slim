...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof OctopusConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: OctopusConfig; env: NodeJS.ProcessEnv }): {
  cfg: OctopusConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
