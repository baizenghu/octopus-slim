...
/** @deprecated Use OctopusConfig instead */
export type { OctopusConfig as ClawdbotConfig } from "../config/config.js";
...
export { refreshAgentStoreCache, invalidateAgentStoreCache } from "../agents/agent-scope.js";
