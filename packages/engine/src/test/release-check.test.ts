        ...
        extensions: [
          {
            ...
            packageJson: {
              ...
              octopus: {
                install: { npmSpec: "@octopus/googlechat" },
                releaseChecks: {
          ...
          },
          {
            ...
            packageJson: {
              ...
              octopus: { install: { npmSpec: "@octopus/feishu" } },
            },
          },
        ],
      }),
...
describe("collectBundledExtensionManifestErrors", () => {
  it("flags invalid bundled extension install metadata", () => {
    expect(
      ...
      "bundled extension 'broken' manifest invalid | octopus.install.npmSpec must be a non-empty string",
    ]);
  });
  ...
  it("flags invalid release-check allowlist metadata", () => {
    expect(
      collectBundledExtensionManifestErrors([
        {
          ...
          packageJson: {
            octopus: {
              install: { npmSpec: "@octopus/broken" },
              releaseChecks: {
      ...
      "bundled extension 'broken' manifest invalid | octopus.releaseChecks.rootDependencyMirrorAllowlist must contain only non-empty strings",
    ]);
  });
});
