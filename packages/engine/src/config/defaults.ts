...
function resolveAnthropicDefaultAuthMode(cfg: OctopusConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: OctopusConfig): OctopusConfig {
...
export function applyTalkApiKey(config: OctopusConfig): OctopusConfig {
...
export function applyTalkConfigNormalization(config: OctopusConfig): OctopusConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: OctopusConfig): OctopusConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: OctopusConfig): OctopusConfig {
...
export function applyLoggingDefaults(cfg: OctopusConfig): OctopusConfig {
...
export function applyContextPruningDefaults(cfg: OctopusConfig): OctopusConfig {
...
export function applyCompactionDefaults(cfg: OctopusConfig): OctopusConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
