...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("octopus.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: OctopusConfig): Promise<ContextEngine> {
