      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["octopus gateway run", "Run the gateway in the foreground."],
            ["octopus gateway status", "Show service status and probe reachability."],
            ["octopus gateway discover", "Find local and wide-area gateway beacons."],
            ["octopus gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.octopus.ai/cli/gateway")}\n`,
      ),
  );
