    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["octopus channels list", "List configured channels and auth profiles."],
          ["octopus channels status --probe", "Run channel status checks and probes."],
          [
            "octopus channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["octopus channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.octopus.ai/cli/channels",
        )}\n`,
    );
