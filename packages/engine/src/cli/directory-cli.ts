    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["octopus directory self --channel slack", "Show the connected account identity."],
          [
            'octopus directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["octopus directory groups list --channel discord", "List available groups/channels."],
          [
            "octopus directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.octopus.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
