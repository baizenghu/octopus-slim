...
export function resolveSubagentToolPolicy(cfg?: OctopusConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: OctopusConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: OctopusConfig["tools"];
