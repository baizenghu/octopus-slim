...
function resolveAdaptiveReadMaxBytes(options?: OctopusReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createOctopusReadTool(base, {
...
export function createOctopusReadTool(
  base: AnyAgentTool,
  options?: OctopusReadToolOptions,
): AnyAgentTool {
