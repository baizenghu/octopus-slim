...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveOctopusAgentDir() returns mainAgentDir
    process.env.OCTOPUS_STATE_DIR = tmpDir;
    process.env.OCTOPUS_AGENT_DIR = mainAgentDir;
