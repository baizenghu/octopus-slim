...
type ModelsConfig = NonNullable<OctopusConfig["models"]>;
...
export function normalizeGoogleModelId(id: string): string {
  ...
  // Preserve compatibility with earlier Octopus docs/config that pointed at a
...
export async function resolveImplicitCopilotProvider(params: {
  ...
  // Octopus keeps auth in auth-profiles and resolves runtime availability from that store.
