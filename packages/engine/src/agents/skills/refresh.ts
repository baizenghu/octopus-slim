...
function resolveWatchPaths(workspaceDir: string, config?: OctopusConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: OctopusConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OctopusConfig }) {
