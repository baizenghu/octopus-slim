...
async function resolveContext(config: OctopusConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): OctopusConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
      ...
      agents: {
        defaults: {
          sandbox: {
            mode: "all",
            scope: "agent",
            workspaceRoot: "~/.octopus/sandboxes",
          },
        },
        list: [
          {
            id: "isolated",
            workspace: "~/octopus-isolated",
            sandbox: {
              mode: "all",
              scope: "agent",
