...
const CLEANUP_STATE_KEY = Symbol.for("octopus.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("octopus.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("octopus.sessionWriteLockWatchdogState");
