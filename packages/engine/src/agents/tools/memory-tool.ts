...
function resolveMemoryToolContext(options: { config?: OctopusConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: OctopusConfig): MemoryCitationsMode {
