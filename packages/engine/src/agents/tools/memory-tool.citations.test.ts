...
function asOctopusConfig(config: Partial<OctopusConfig>): OctopusConfig {
  return config as OctopusConfig;
}

function createToolConfig() {
  return asOctopusConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: OctopusConfig = createToolConfig()) {
