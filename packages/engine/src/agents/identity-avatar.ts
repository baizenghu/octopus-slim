...
function resolveAvatarSource(cfg: OctopusConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OctopusConfig, agentId: string): AgentAvatarResolution {
