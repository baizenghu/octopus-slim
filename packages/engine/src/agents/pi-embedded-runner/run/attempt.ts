...
import { resolveOctopusDocsPath } from "../../docs-path.js";
...
import { createOctopusCodingTools, resolveToolLoopDetectionConfig } from "../../pi-tools.js";
...
import { getMessagesAfterCompactBoundary } from "../../compact-boundary.js";
...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    const agentDir = params.agentDir ?? resolveOctopusAgentDir();
    ...
    const docsPath = await resolveOctopusDocsPath({
      workspaceDir: effectiveWorkspace,
    ...
    try {
      ...
      try {
        ...
        const validated = transcriptPolicy.validateAnthropicTurns
          ...
          : validatedGemini;
        const afterBoundary = getMessagesAfterCompactBoundary(validated);
      ...
      try {
        ...
        // double-compaction. See: https://github.com/octopus/octopus/issues/9282
        ...
        if (promptError && promptErrorSource === "prompt" && !compactionOccurredThisAttempt) {
          try {
            sessionManager.appendCustomEntry("octopus:prompt-error", {
              timestamp: Date.now(),
              runId: params.runId,
              sessionId: params.sessionId,
              provider: params.provider,
      ...
      // See: https://github.com/octopus/octopus/issues/8643
