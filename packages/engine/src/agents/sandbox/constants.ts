...
export const DEFAULT_SANDBOX_IMAGE = "octopus-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "octopus-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "octopus-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "octopus-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "octopus-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "octopus-sandbox-browser";
