...
import { DEFAULT_BROWSER_EVALUATE_ENABLED, ensureBrowserControlAuth, resolveBrowserControlAuth } from "../../browser/index.js";
...
function resolveSandboxSession(params: { config?: OctopusConfig; sessionKey?: string }) {
