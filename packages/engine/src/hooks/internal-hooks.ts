/**
 * Hook system for Octopus agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __octopus_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__octopus_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
