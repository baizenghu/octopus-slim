...
describe("QmdMemoryManager", () => {
  ...
  async function createManager(params?: { mode?: "full" | "status"; cfg?: OctopusConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__octopusMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__octopusMcporterColdStartWarned;
  });
