...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.octopus.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", OCTOPUS_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("enables, bootstraps, and kickstarts the resolved label", async () => {
    ...
    const label = "ai.octopus.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.octopus.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when OCTOPUS_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.octopus.gateway.plist",
    },
    {
      name: "uses profile-specific label when OCTOPUS_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", OCTOPUS_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.octopus.jbphoenix.plist",
    },
    {
      name: "prefers OCTOPUS_LAUNCHD_LABEL over OCTOPUS_PROFILE",
      env: {
        HOME: "/Users/test",
        OCTOPUS_PROFILE: "jbphoenix",
        OCTOPUS_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from OCTOPUS_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        OCTOPUS_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty OCTOPUS_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        OCTOPUS_PROFILE: "myprofile",
        OCTOPUS_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.octopus.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
