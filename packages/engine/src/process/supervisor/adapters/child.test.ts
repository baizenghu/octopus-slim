...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.OCTOPUS_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.OCTOPUS_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.OCTOPUS_SERVICE_MARKER = originalServiceMarker;
    }
  });
