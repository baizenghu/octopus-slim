...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: OctopusConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: OctopusConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: OctopusConfig) => string;
  setAccountEnabled?: (params: {
    cfg: OctopusConfig;
    accountId: string;
    enabled: boolean;
  }) => OctopusConfig;
  deleteAccount?: (params: { cfg: OctopusConfig; accountId: string }) => OctopusConfig;
  isEnabled?: (account: ResolvedAccount, cfg: OctopusConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: OctopusConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: OctopusConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: OctopusConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: OctopusConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.octopus.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: OctopusConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
