...
export function listChannelMessageActions(cfg: OctopusConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: OctopusConfig): boolean {
...
export function supportsChannelMessageCards(cfg: OctopusConfig): boolean {
