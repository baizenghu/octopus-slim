...
export type ChannelAgentToolFactory = (params: { cfg?: OctopusConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: OctopusConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
   ...
   */
  listActions?: (params: { cfg: OctopusConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: OctopusConfig }) => boolean;
  supportsCards?: (params: { cfg: OctopusConfig }) => boolean;
