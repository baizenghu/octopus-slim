...
import { discoverOctopusPlugins } from "../../plugins/discovery.js";
import type { OctopusPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, OctopusPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["OCTOPUS_PLUGIN_CATALOG_PATHS", "OCTOPUS_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<OctopusPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: OctopusPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: OctopusPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverOctopusPlugins({ workspaceDir: options.workspaceDir });
