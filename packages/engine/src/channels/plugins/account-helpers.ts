...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: OctopusConfig): string | undefined {
  ...
  function listConfiguredAccountIds(cfg: OctopusConfig): string[] {
  ...
  function listAccountIds(cfg: OctopusConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: OctopusConfig): string {
