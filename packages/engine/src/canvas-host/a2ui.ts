...
export const A2UI_PATH = "/__octopus__/a2ui";

export const CANVAS_HOST_PATH = "/__octopus__/canvas";

export const CANVAS_WS_PATH = "/__octopus__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.octopusCanvasA2UIAction.postMessage(...)
  // - Android: window.octopusCanvasA2UIAction.postMessage(...)
  const handlerNames = ["octopusCanvasA2UIAction"];
  ...
  globalThis.Octopus = globalThis.Octopus ?? {};
  globalThis.Octopus.postMessage = postToNode;
  globalThis.Octopus.sendUserAction = sendUserAction;
  globalThis.octopusPostMessage = postToNode;
  globalThis.octopusSendUserAction = sendUserAction;
