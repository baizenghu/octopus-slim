...
export function isAcpEnabledByPolicy(cfg: OctopusConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: OctopusConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: OctopusConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: OctopusConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: OctopusConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: OctopusConfig, agentId: string): boolean {
