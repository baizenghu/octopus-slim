...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: OctopusConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: OctopusConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: OctopusConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: OctopusConfig }): Promise<void> {
