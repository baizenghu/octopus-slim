...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@octopus", { botUsername: "octopus" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@octopus args", {
        botUsername: "octopus",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "octopus" })).toBe(
      "/help@otherbot",
    );
  });
