...
function resolveAcpStreamCoalesceIdleMs(cfg: OctopusConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: OctopusConfig): number {
...
export function resolveAcpProjectionSettings(cfg: OctopusConfig): AcpProjectionSettings {
