...
function resolveMentionPatterns(cfg: OctopusConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: OctopusConfig | undefined, agentId?: string): RegExp[] {
