...
export function listWhatsAppAuthDirs(cfg: OctopusConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: OctopusConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: OctopusConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: OctopusConfig): ResolvedWhatsAppAccount[] {
