...
let originalOctopusTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalOctopusTestConsole = process.env.OCTOPUS_TEST_CONSOLE;
  process.env.OCTOPUS_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalOctopusTestConsole === undefined) {
    delete process.env.OCTOPUS_TEST_CONSOLE;
  } else {
    process.env.OCTOPUS_TEST_CONSOLE = originalOctopusTestConsole;
  }
