...
export type OctopusPluginConfigSchema = {
...
export type OctopusPluginToolContext = {
...
export type OctopusPluginToolFactory = (
  ctx: OctopusPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type OctopusPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type OctopusPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type OctopusPluginGatewayMethod = {
  method: string;
 ...
 */
export type OctopusPluginCommandDefinition = {
...
export type OctopusPluginHttpRouteAuth = "gateway" | "plugin";
export type OctopusPluginHttpRouteMatch = "exact" | "prefix";

export type OctopusPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean | void> | boolean | void;

export type OctopusPluginHttpRouteParams = {
  path: string;
  handler: OctopusPluginHttpRouteHandler;
  auth: OctopusPluginHttpRouteAuth;
  match?: OctopusPluginHttpRouteMatch;
  replaceExisting?: boolean;
};

export type OctopusPluginCliContext = {
  program: Command;
  config: OctopusConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type OctopusPluginCliRegistrar = (ctx: OctopusPluginCliContext) => void | Promise<void>;

export type OctopusPluginServiceContext = {
  config: OctopusConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type OctopusPluginService = {
  id: string;
  start: (ctx: OctopusPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: OctopusPluginServiceContext) => void | Promise<void>;
};

export type OctopusPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type OctopusPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: OctopusPluginConfigSchema;
  register?: (api: OctopusPluginApi) => void | Promise<void>;
  activate?: (api: OctopusPluginApi) => void | Promise<void>;
};

export type OctopusPluginModule =
  | OctopusPluginDefinition
  | ((api: OctopusPluginApi) => void | Promise<void>);

export type OctopusPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | OctopusPluginToolFactory,
    opts?: OctopusPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: OctopusPluginHookOptions,
  ) => void;
  registerHttpRoute: (params: OctopusPluginHttpRouteParams) => void;
  registerChannel: (registration: OctopusPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: OctopusPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: OctopusPluginService) => void;
   ...
   */
  registerCommand: (command: OctopusPluginCommandDefinition) => void;
