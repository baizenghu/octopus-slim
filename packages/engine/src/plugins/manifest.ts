...
export const PLUGIN_MANIFEST_FILENAME = "octopus.plugin.json";
...
// package.json "octopus" metadata (used for onboarding/catalog)
...
export type OctopusPackageManifest = {
  extensions?: string[];
...
): OctopusPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
