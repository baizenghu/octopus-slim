...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/octopus/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/octopus/extensions",
        global: "/Users/x/.octopus/extensions",
        workspace: "/Users/x/ws/.octopus/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.octopus/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/octopus/extensions",
        global: "/Users/x/.octopus/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.octopus/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/octopus/extensions",
        global: "/Users/x/.octopus/extensions",
