...
import type {
  OctopusPluginApi,
  OctopusPluginChannelRegistration,
  OctopusPluginCliRegistrar,
  OctopusPluginCommandDefinition,
  OctopusPluginHttpRouteAuth,
  OctopusPluginHttpRouteMatch,
  OctopusPluginHttpRouteHandler,
  OctopusPluginHttpRouteParams,
  OctopusPluginHookOptions,
  ProviderPlugin,
  OctopusPluginService,
  OctopusPluginToolContext,
  OctopusPluginToolFactory,
  PluginConfigUiHint,
  PluginDiagnostic,
  PluginLogger,
  PluginOrigin,
...
export type PluginToolRegistration = {
  pluginId: string;
  factory: OctopusPluginToolFactory;
  names: string[];
  optional: boolean;
  source: string;
};
...
export type PluginCliRegistration = {
  pluginId: string;
  register: OctopusPluginCliRegistrar;
  commands: string[];
  source: string;
};
...
export type PluginServiceRegistration = {
  pluginId: string;
  service: OctopusPluginService;
  source: string;
};

export type PluginCommandRegistration = {
  pluginId: string;
  command: OctopusPluginCommandDefinition;
  source: string;
};
...
export function createPluginRegistry(registryParams: PluginRegistryParams) {
  ...
  const registerTool = (
    ...
    const factory: OctopusPluginToolFactory =
      typeof tool === "function" ? tool : (_ctx: OctopusPluginToolContext) => tool;
  ...
  const registerHook = (
    ...
    opts: OctopusPluginHookOptions | undefined,
    config: OctopusPluginApi["config"],
  ) => {
  ...
  const registerHttpRoute = (record: PluginRecord, params: OctopusPluginHttpRouteParams) => {
  ...
  const registerChannel = (
    record: PluginRecord,
    registration: OctopusPluginChannelRegistration | ChannelPlugin,
  ) => {
    const normalized =
      typeof (registration as OctopusPluginChannelRegistration).plugin === "object"
        ? (registration as OctopusPluginChannelRegistration)
  ...
  const registerCli = (
    record: PluginRecord,
    registrar: OctopusPluginCliRegistrar,
  ...
  const registerService = (record: PluginRecord, service: OctopusPluginService) => {
  ...
  const registerCommand = (record: PluginRecord, command: OctopusPluginCommandDefinition) => {
