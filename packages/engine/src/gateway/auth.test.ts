...
describe("gateway auth", () => {
  ...
  it("resolves token/password from OCTOPUS gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          OCTOPUS_GATEWAY_TOKEN: "env-token",
          OCTOPUS_GATEWAY_PASSWORD: "env-password",
    ...
    expect(
      resolveGatewayAuth({
        authConfig: {
          ...
          password: "${OCTOPUS_GATEWAY_PASSWORD}",
        },
        env: {
          OCTOPUS_GATEWAY_TOKEN: "env-token",
          OCTOPUS_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides OCTOPUS_GATEWAY_PASSWORD", () => {
