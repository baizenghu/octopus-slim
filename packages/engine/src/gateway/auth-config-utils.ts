import type { GatewayAuthConfig, OctopusConfig } from "../config/config.js";
import { resolveSecretInputRef } from "../config/types.secrets.js";
import { resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string.js";

export function withGatewayAuthPassword(cfg: OctopusConfig, password: string): OctopusConfig {
  return {
    ...cfg,
    gateway: {
      ...cfg.gateway,
