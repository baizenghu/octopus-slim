...
export function hasAmbiguousGatewayAuthModeConfig(cfg: OctopusConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: OctopusConfig): void {
