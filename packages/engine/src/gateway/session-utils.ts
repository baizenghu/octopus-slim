...
function listConfiguredAgentIds(cfg: OctopusConfig): string[] {
...
export function listAgentsForGateway(cfg: OctopusConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OctopusConfig): string {
...
function resolveSessionStoreAgentId(cfg: OctopusConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: OctopusConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: OctopusConfig): GatewaySessionsDefaults {
